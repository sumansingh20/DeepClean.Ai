      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 dark:from-blue-700 dark:via-indigo-700 dark:to-purple-800 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
            Secure AI-Powered<br />Detection Platform
          </h1>
          <p className="text-xl text-white/80 mb-8 leading-relaxed">
            Advanced deepfake detection using cutting-edge machine learning technology. Trusted by professionals worldwide.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white dark:bg-dark-100">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-dark-600">Sign in to access your dashboard</p>
          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3.5 border-2 border-gray-300 dark:border-dark-300 rounded-xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:focus:ring-blue-900/30 transition-all text-gray-900 dark:text-white bg-white dark:bg-dark-200 font-medium"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-12 pr-12 py-3.5 border-2 border-gray-300 dark:border-dark-300 rounded-xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:focus:ring-blue-900/30 transition-all text-gray-900 dark:text-white bg-white dark:bg-dark-200 font-medium"
                      placeholder="••••••••"
                    />
                    <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-dark-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
